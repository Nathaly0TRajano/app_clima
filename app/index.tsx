...
function App() {       //App é a função principal
    ...
    return (
        <View style={[styles.container, night ? styles.containerBgNight : styles.containerBgDay]} >
            ...
            <View style={styles.detailsContainer}>
                <Text style={styles.temperature}>39 ºC</Text>
                <Image source={night ? require('../assets/images/noite.png') : require('../assets/images/sol.png')} style={styles.weatherIcon} />
            </View>
            <View>
                <Text style={styles.weatherCondition}>Ensolarado</Text>
                <Text style={styles.text}>Sensação Térmica: 45 ºC</Text>
